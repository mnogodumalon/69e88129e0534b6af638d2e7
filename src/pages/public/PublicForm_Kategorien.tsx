...
const PROXY_BASE = '';
const APP_ID = '69e8810fdd12d6d0097878ed';
...
export default function PublicFormKategorien() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Kategorien — Formular</h1>
        </div>
